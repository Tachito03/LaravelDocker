...
class CreateReporteSolicitudEppTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reporte_solicitud_epp', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('reporte_solicitud_epp');
    }
}
