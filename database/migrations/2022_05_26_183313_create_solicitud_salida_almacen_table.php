...
class CreateSolicitudSalidaAlmacenTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('solicitud_salida_almacen', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('solicitud_salida_almacen');
    }
}
