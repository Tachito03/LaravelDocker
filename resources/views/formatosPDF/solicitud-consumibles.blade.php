    ...
    <table>
        <thead>
            <tr>
                ...
                <td colspan="4" style="text-align: right;"><p style="color: #aaaaaa">{{ $consumible_detalle[0]->nomenclatura_documento }}</p></td>
            </tr>
            <tr>
                <td colspan="8"></td>
                <td colspan="1">Año: {{ $consumible_detalle[0]->anio }}</td>
                <td colspan="1">Mes: {{ $consumible_detalle[0]->mes }}</td>
                <td colspan="1">Folio Solicitud</td>
                <td colspan="1" style="text-align: right;">{{ $consumible_detalle[0]->folio_solicitud }}</td>
            </tr>
            <tr>
                <td colspan="10"></td>
                <td colspan="1">Folio Entrega</td>
                <td colspan="1" style="text-align: right;">{{ $consumible_detalle[0]->folio_entrega }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="12" style="border-left: 2px solid #000; border-right: 2px solid #000;">
                    <h3></strong><strong style="color: #aaaaaa">SOLICITUD, CONSUMIBLES</strong></h3>
                </td>
            </tr>
            <tr>
                <td colspan="1" style="border-left: 2px solid #000 ;" ><strong>Nombre del solicitante: </strong></td>
                <td colspan="7">{{ $consumible_detalle[0]->id_solicitante }}<hr></td>
                <td colspan="1"></td>
                <td colspan="1"><strong>Fecha: </strong></td>
                <td colspan="2" style="border-right: 2px solid #000 ;">{{ $consumible_detalle[0]->fecha }}<hr></td>
            </tr>
           <tr>
                <td colspan="1" style="border-left: 2px solid #000 ;"><strong>Nombre del proyecto: </strong></td>
                <td colspan="7">{{ $consumible_detalle[0]->id_proyecto }}<hr></td>
                <td colspan="1"></td>
                <td colspan="1"><strong>Fecha Requerida: </strong></td>
                <td colspan="2" style="border-right: 2px solid #000 ;">{{ $consumible_detalle[0]->fecha_requerida }}<hr></td>
            </tr>
            <tr>
                <td colspan="1" style="border-left: 2px solid #000 ;"><strong>Lugar: </strong></td>
                <td colspan="7">{{ $consumible_detalle[0]->lugar }}<hr></td>
                <td colspan="1"></td>
                <td colspan="1"><strong>Área Solicitante: </strong></td>
                <td colspan="2" style="border-right: 2px solid #000 ;">{{ $consumible_detalle[0]->id_area }}<hr></td>
            </tr>
            <tr>
                <td colspan="1" style="border-left: 2px solid #000 ;"><strong>Duración: </strong></td>
                <td colspan="7">{{ $consumible_detalle[0]->duracion }}<hr></td>
                <td colspan="1"></td>
                <td colspan="1"><strong>Gerente Responsable: </strong></td>
                <td colspan="2" style="border-right: 2px solid #000 ;">{{ $consumible_detalle[0]->id_gerente_responsable }}<hr></td>
            </tr>
            <tr><td colspan="12" style="border-top: 2px solid #000"></td></tr>
            <tr>
                <td class="space-observaciones" colspan="12"></td>
        ...
        <tbody>
            ...
            @foreach ($consumible_detalle as $detalle)
                <tr class="descripcion-body">
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="10" style="border: 1px solid #000" class="observaciones">
                    {{ $consumible_detalle[0]->observaciones }}
                </td>
                <td colspan="1"></td>
            </tr>
            <tr><td class="thfooter"></td></tr>
            ...
            <tr>
                <td colspan="2"></td>
                <td colspan="2"></td>
                <td colspan="4" style="text-align: center; border: 1px solid #000"><strong>Consumibles</strong></td>
                <td colspan="2"></td>
                <td colspan="2"></td>               
            </tr>
            <tr>
